...
BAND_EXCEPTIONS = {
    ...
    "1001530": "sub-scope single (0.262 sq ft) — eleventh sub-scope data point; $17.18/sq ft at qty 20 intentionally above the $15.43/sq ft root floor (1230820) per sub-scope premium doctrine (+11.3%); full 4-wave AI validation 2026-07-21, unanimous Wave 4 approval, no tier modifications; sits between 1001220 (0.231 sq ft, nearest smaller neighbor) and 3017572 (0.365 sq ft, nearest larger neighbor) on the gradient; flat tail (50-99 through 200+, $4.25/ea, $16.22/sq ft) achieves near-exact parity with 1001220's own flat tail ($16.23/sq ft); all six tiers §31-compliant natively, no One-Time Exception needed; §32 chain-consistency flag on the 1-9 tier vs. nearest larger neighbor 3017572 (~5.2 increments short) — flagged, not corrected, per §32's own governing language; see items/1001530.md Pricing Derivation Steps 4-6; excluded from singles band data points until production-volume acceptance",
