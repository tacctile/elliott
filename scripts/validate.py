...
BAND_EXCEPTIONS = {
    ...
    "3024180": "Micro-Format Band item at 0.073 sq ft — EXACT PARITY with P/N 1012080 (0.077 sq ft, size ratio 0.948) at $2.50/qty 20 ($34.25/sq ft), intentionally above the $30.86/sq ft linear formula output; no AI validation waves run, parity match is the validation methodology per governance/PRICING_VALIDATION.md. Band anchor unchanged (1279000, $30.86/sq ft). FLAGGED (documented, not corrected): this item is ANSI-marked (LBL-EMERGENCY STOP) but priced at parity with 1012080, a non-ANSI benchmark — see items/3024180.md ANSI / Non-ANSI Classification Flag. Nick-approved parity price, 2026-07-29.",
    ...
    "1205870": "per-label floor governs at $2.75/qty 20 (ANSI, §29) — at 0.049 sq ft the linear Micro-Format Band formula ($30.86/sq ft × 0.049 = $1.51) is inapplicable; implied $/sq ft ($56.12) is an arithmetic artifact of per-label floor governance, not the pricing basis; tier table matches 1279260/1279270 exactly; corrected 2026-07-15 (post-audit cleanup session) — originally filed at the retired $2.50 non-ANSI floor sixteen days after §29 took effect with no override_type logged; §29 governance-compliance correction, not a new pricing decision",
    ...
    "3020370": "sub-scope single (0.105 sq ft) — smallest sub-scope item on file, closest to Micro-Format Band boundary (0.1 sq ft); $26.19/sq ft at qty 20 intentionally above the $15.43/sq ft root floor (1230820) per sub-scope premium doctrine, correctly above 1247120 ($22.54/sq ft at 0.122 sq ft); OWNER JUDGMENT — tier ladder adopted directly from P/N 1247120 (0.122 sq ft, ~14% larger), 4-wave validation skipped by Nick's direction on the basis that the 0.017 sq ft size delta is trivial; dimensions and material cost independently derived per §25 canonical (NOT a dimensional parity clone); all six tiers are §31-compliant at $2.75/ea at qty 20 ($26.19/sq ft), well above the $15.43/sq ft floor; excluded from singles band data points until production-volume acceptance; see items/3020370.md Pricing Derivation Step 4",
    "127763A": "sub-scope single (0.4861 sq ft) — below the ~0.5 sq ft singles-band scope floor, sitting just under governing benchmark 1062390 (0.503 sq ft, standard singles-band item); DIRECT PARITY EXEMPTION — tier table byte-identical to 1062390 ($16.50/$10.50/$8.00/$6.25/$5.25/$4.25), Nick-locked and already quoted to the customer, no new AI validation run; material cost ($0.95/label) independently calculated per §25 canonical for this item's own 0.4861 sq ft footprint, NOT cloned from 1062390's $0.98/label; $16.46/sq ft at qty 20, above the singles band ceiling ($15.91/sq ft) per the sub-scope small-format-premium doctrine; the 50-99/100-199/200+ tiers ($12.86/$10.80/$8.74 per sq ft) do NOT clear the §31 sub-scope root floor ($15.43/sq ft at every tier) — documented deviation, NOT corrected, per explicit session instruction that §31 floor logic does not apply to this pre-quoted, Nick-locked filing; excluded from both singles-band and sub-scope band data points (parity-clone filing, not an independent validated data point in either band) — see items/127763A.md Pricing Derivation Steps 3-4",
    "101903A": "per-label floor governs at $2.50/qty 20 (non-ANSI, complexity-dependent floor) — at 0.023 sq ft the linear Micro-Format Band formula ($30.86/sq ft × 0.023 = $0.71) is inapplicable; implied $/sq ft ($108.70) is a mathematical artifact of per-label floor governance, not the pricing basis; tier table byte-identical to 3024140 (governing comparable, 0.019 sq ft, non-ANSI simple control label); priced via direct match to 3024140 per Nick's manual routing 2026-08-10, not via calculator or 4-wave AI validation; calculator F26 STOP confirmed 3024140 as the correct non-ANSI governing comparable; fourth sub-0.06 sq ft production item on the account; see items/101903A.md",
    "3010722": "cut vinyl Band A (1.167 sq ft) — new lower edge of Band A; $14.36/sq ft at qty 20 intentionally above the $13.65-$13.94/sq ft concession corridor as a deliberate small-format premium established by full 4-wave, 24-model AI validation (Waves 1-4, 6 models/wave), NOT a benchmark scale-off; below the $14.84-$16.41/sq ft AI-consensus normalized band; price locked by Nick 2026-07-15; color-parity set with 3010723/3010724, identical pricing; material cost corrected 2026-07-15 (post-audit cleanup) from $3.70/label (deprecated area-based tape pseudo-rate) to $3.31/label (length-based tape, vinyl unchanged) — a same-day $4.17 self-correction attempt was itself wrong (over-applied vinyl spacing) and is retracted — see items/3010722.md",
    "3010723": "cut vinyl Band A (1.167 sq ft) — color parity with 3010722 (Cardinal Red); identical $14.36/sq ft small-format premium rationale; identical corrected material cost ($3.31/label, 2026-07-15) in lockstep with 3010722; see BAND_EXCEPTIONS['3010722'] and items/3010723.md",
    "3010724": "cut vinyl Band A (1.167 sq ft) — color parity with 3010722 (Cardinal Red); identical $14.36/sq ft small-format premium rationale; identical corrected material cost ($3.31/label, 2026-07-15) in lockstep with 3010722; see BAND_EXCEPTIONS['3010722'] and items/3010724.md",
    ...
    "ELLIOTT-BOOM-DECAL": "cut vinyl Band A (2.300 sq ft) — VARIABLE-BOM item: ships as 1-color White (Config A, first production run, canonical material cost $6.68/label) or 2-color Black+Red (Config B, $14.48/label, documentation only) per Elliott's order, price identical either way; $15.22/sq ft at qty 20 is a direct dollar-tier-table match to P/N 1186310 (closest sq ft/price match), also byte-identical to 3018378 and 3017435 ($45/$40/$35/$30/$26/$22) — NOT scaled to this item's smaller 2.300 sq ft footprint; above BOTH the $13.65-$13.94/sq ft Relationship Concession Corridor and the $14.33-$14.36/sq ft Small-Format Premium Corridor; Nick-confirmed and quoted directly to Sean — the calculator's own validation brief proposed a lower Band A default table ($40/$35/$30/$25/$22/$19), explicitly rejected; §32 Direction B fully satisfied (this smaller item prices well ABOVE its larger validated neighbors' $/sq ft, the required direction — not a violation); non-standard, Nick-assigned P/N (no numeric Elliott drawing P/N exists); excluded from Band A data points (direct price-match filing, not an independently validated $/sq ft data point, same treatment as 1257750) — see items/ELLIOTT-BOOM-DECAL.md",
    "1277330": "printed/laminated singles (0.535 sq ft) — DIRECT PARITY EXEMPTION clone of the 0.503 sq ft cluster's tier table (1062390/1068270/1073950/1132950), byte-identical ($16.50/$10.50/$8.00/$6.25/$5.25/$4.25); comparable selected on catalog-alignment precedent — four independently quoted P/Ns sharing one identical tier table — NOT sq ft proximity to the nearer neighbor 1267140 (0.560 sq ft, 4.7% larger); externally validated 2026-08-18 via a full 4-wave, 6-model AI process run in ChatHub and synthesized in Claude Chat, unanimous 6/6 on price at Wave 1 alone, the only correction was to the comparable-selection rationale, not price; because this item's own footprint (0.535 sq ft) is 6.4% larger than the 0.503 sq ft cluster it clones, its own $/sq ft at qty 20 is $14.95 — BELOW the singles band floor ($15.43/sq ft, root benchmark 1230820) — the mirror image of 101903A/127763A (which clone a same-price benchmark onto a SMALLER footprint and land ABOVE the band); §32 does not apply — direct-parity clones are excluded from that comparison by definition; excluded from singles-band DATA POINTS (parity clone, not a new independent data point); labor-absorption flag documented (Elliott's order history never exceeds qty 20 — 1-9/10-19 tiers carry the real margin-exposure risk, not 200+), tier table unchanged — see items/1277330.md",
    "3021615": "cut vinyl, FIRST MULTI-PIECE NESTED-SET item on the account — one P/N covers a 5-piece boom-length marker kit ('24'/'30'/'35'/'40'/'45'), sold and priced as ONE unit, never split, never priced per-marker; sq_ft_per_label (0.192) is the per-marker area only, NOT a meaningful $/sq ft basis for this item — the implied $/sq ft (~$76.8 at qty 20) is a mathematical artifact of a kit whose cost is driven by full-roll-width feed-pitch consumption, not by per-label area, and does not route through the Band A/B/C Pricing Profile at all; priced via an independent 4-wave, 6-model AI validation process (run externally in ChatHub, synthesized in Claude Chat) using P/N 3010736 as a verified-cost-delta bridge only (NOT a structural comparable); Wave 4 synthesized/locked $14.95 at qty 20, Nick applied an Owner Judgment override to $14.75 based on Elliott's account history of never ordering above qty 20; material cost $2.86/set (verified: vinyl $2.5677 + tape $0.2955) from a non-standard nesting model — 5 numbers rotated 90°, nested at a fixed 4.25\" repeating width, run across the full 30\" roll width per repeat at a 7.5\" feed pitch, a deliberate one-carrier-sheet production choice, NOT a material-efficiency nest; excluded from the 12 confirmed Band A data points; §32 does not apply (kits excluded from that comparison by definition); this item's nesting/cost model must NOT be cloned by a future multi-piece item without independent derivation — see items/3021615.md",
}
