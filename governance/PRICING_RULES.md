...
**Corridor scoping (added 2026-07-22) — chain consistency applies only within the same pricing corridor.** §32's Direction B comparison is only valid between two items that occupy the **same** deliberately-priced corridor. Band A cut vinyl currently contains two such corridors, priced differently from each other **by design**, not by error — running Direction B *across* them manufactures a false-positive violation, because it treats a deliberate structural gap between corridors as if it were a same-corridor inversion. Before running the §32 comparison on any pair, confirm both items' corridor membership; if they differ, §32 does not apply to that pair — do not flag it, and instead check the pair's nearest same-corridor neighbor.

The two Band A corridors, as currently populated:

- **Relationship Concession Corridor** — items **≥ ~1.5 sq ft**, priced **$13.65–$13.94/sq ft**, founded on P/N 1205720 (Band A root benchmark, permanent §32 exception). Current members: 3010698 (1.582 sq ft), 3023921 (1.656 sq ft), the 2.51–2.564 sq ft cluster (1205720, 1186310, 3017435, 3018378), 1146650 (2.971 sq ft), 3010701 (3.202 sq ft).
- **Small-Format Premium Corridor** — items **< ~1.2 sq ft**, priced **$14.33–$14.36/sq ft** as a deliberate, independently 4-wave-validated premium above the concession corridor. Current members: 3010736 (1.012 sq ft, $14.33/sq ft), 1257750 (1.076 sq ft, price-replication filing — see `items/1257750.md`), 3010722/3010723/3010724 (1.167 sq ft, $14.36/sq ft).

A pair drawn from the same corridor is still fully subject to Direction B — corridor scoping exempts *cross*-corridor pairs only, it does not exempt any item from comparison against its own corridor's neighbors. The ~1.2–1.5 sq ft gap between the two corridors currently has no data points; an item filed there needs its own corridor determination (via 4-wave validation) before §32 can be run against it in either direction. This scoping rule extends to any future pricing corridor established in this or any other material family under the same logic — an above-band or below-band premium/discount that is itself the product of deliberate, documented validation is a corridor, and cross-corridor §32 comparisons against it are out of scope.
