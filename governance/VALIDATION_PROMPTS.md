...
>
> Last Updated: 2026-07-15 (governance drift remediation — §3 Deep Volume Tier Instruction rewritten: §31 (sub-scope root floor, governance/PRICING_RULES.md, established 2026-07-01) is now a stated hard precondition for sub-scope items, checked before the "clean round number" step-down guidance. The prior unconditional wording ("only requirement is the ladder never inverts") produced two real Nick-directed One-Time-Exception corrections after the validation record had already closed (P/N 3017572, P/N 1101250) — see audits/2026-07-15-governance-drift-audit.md. Previously 2026-06-22: §3: $55 account floor replaced with no-floor job-economics doctrine; deep-tier standing instruction added to Wave 1 prompt template. Previously 2026-06-09 Session I: $50 rush/favor floor note added; 1230820 root-benchmark anchor verified. Previously Session H / audit H-3 — Section 3 band fence rebuilt to embed ALL SIX bands; all current benchmark anchors added; Section 5 MOQ stub replaced)
...
**Sub-scope items (0.1-0.5 sq ft) — §31 is a hard precondition, checked BEFORE the guidance above:** `governance/PRICING_RULES.md` §31 establishes the $15.43/sq ft root benchmark rate (P/N 1230820) as a hard floor at EVERY tier of a sub-scope item, not just the qty-20 rate. Step deep tiers down cleanly only until the floor is reached. Once a tier's price would fall to or below $15.43/sq ft × the item's sq ft, HOLD FLAT at the cheapest $0.25-increment price that clears the floor for that tier and every deeper (higher-quantity) tier — do not keep stepping down past the floor to chase a "clean round number." A below-floor deep tier teaches the buyer the floor is negotiable at volume, which §31 exists specifically to prohibit. This is not a hypothetical risk: it produced two real Nick-directed One-Time-Exception corrections after the validation record had already closed — P/N 3017572 and P/N 1101250 — neither of which should have been necessary if the floor had been a stated precondition of the wave prompt itself. The no-splitting-hairs guidance above still governs every tier that clears the floor; it does not override the floor.

The only hard requirements are: (1) the ladder never inverts — each tier must be less than or equal to the tier above it — across every item type; and (2) for sub-scope items specifically, no tier at any quantity may price below the §31 floor.
