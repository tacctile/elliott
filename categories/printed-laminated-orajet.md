...
⁴ **DIRECT PARITY CLONE OF P/N 1082570** added 2026-06-09 (Session F). Dimensions are orientation-flipped (7.25" W × 10.00" H vs 10.00" W × 7.25" H on 1082570) — sq ft is identical at 0.503. Identical material family (Orajet 3951 Cast + Polyester Lam), identical process (Print/Lam/Cut, 1 pass), identical material cost ($1.33/label, full bleed per PRICING_RULES.md §25), identical tier table ($16.50 / $10.50 / $8.00 / $6.25 / $5.25 / $4.25), identical margin profile (~83% at qty 20, ~69% at 200+). Artwork content differs (G85 basket jib 500# load chart vs I70 EZR Mount 3.6K). **Direct parity exemption applied per `governance/PRICING_VALIDATION.md`** — no multi-round AI validation required; the 4-round / 6-model / 24-run validation on 1082570 is inherited. Rule 15 (Pricing Profile band check) still applies and is satisfied — $15.91/sq ft at qty 20 lands cleanly within the singles band ($15.43–$15.91/sq ft). No first article requested or offered. See `items/1068270.md` for full documentation.
