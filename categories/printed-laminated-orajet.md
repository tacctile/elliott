...
**Data points:** 1 founding data point (1279000 at 0.097 sq ft, $3.00/qty 20, $30.86/sq ft — 2026-06-05). 1 sub-0.06 sq ft per-label floor anchor (3024592 at 0.054 sq ft, $2.75/qty 20 — **floor-governed**, NOT linear $/sq ft extrapolation — 4-wave validated 2026-06-16; see floor caution below).
...
**Per-label floor caution — CONFIRMED at 0.054 sq ft (3024592, 2026-06-16):** The $/sq ft anchor ($30.86) must NOT be linearly extrapolated below ~0.06 sq ft. At extreme smallness, a per-label floor (~$2.50–$3.00 at qty 20) overrides $/sq ft scaling because fixed labor per label has a minimum regardless of how small the label gets. **This floor is now confirmed with a live production item:** P/N 3024592 at 0.054 sq ft — the linear formula yields $1.67 at qty 20, but the 4-wave-validated floor is **$2.75 at qty 20**. Items below ~0.06 sq ft require fresh job-economics validation, not a linear $/sq ft formula. Do NOT linearly extrapolate downward from 3024592's $2.75 either — future sub-0.06 sq ft items must validate fresh against job economics and compare to the floor band (~$2.50–$3.00 at qty 20).
