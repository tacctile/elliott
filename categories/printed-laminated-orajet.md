...
Items in the 0.1–0.5 sq ft range (such as P/N 1210810 at 0.292 sq ft and P/N 1247120 at 0.122 sq ft) are below the band scope floor but above the tiny-label threshold. Correct approach: price at band-consistent $/sq ft with a small-format premium (do NOT use the sub-scope position to justify a below-band rate — smaller labels carry higher fixed cost per sq ft, not lower). Sub-scope $/sq ft must be above the singles band ($15.43–$15.91/sq ft) at the qty-20 tier. Exclude from band DATA POINTS until production-volume acceptance confirmed by Nick.
...
- **Sub-scope (0.1–0.5 sq ft):** band-consistent $/sq ft with small-format premium. Two confirmed sub-scope data points: 1210810 at 0.292 sq ft, $4.75 at qty 20 = $16.27/sq ft (+5.4% above band, 4-wave validated 2026-06-01); 1247120 at 0.122 sq ft, $2.75 at qty 20 = $22.54/sq ft (+46.1% above band root, 4-wave validated 2026-06-16). Sub-scope premium doctrine: smaller sub-scope labels carry higher $/sq ft — $22.54 > $16.27 > $15.43–$15.91 is the correct gradient. Both excluded from band DATA POINTS until production-volume acceptance confirmed by Nick.
